...
<head>
    ...
    <title>تنبيه فاتورة متأخرة</title>
</head>
                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden;">
                    <tr>
                        <td style="background-color:#dc2626; padding:20px 32px;">
                            <h1 style="margin:0; color:#ffffff; font-size:18px;">تنبيه: فاتورة متأخرة السداد</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px 32px; color:#1f2937; font-size:14px; line-height:1.8;">
                            ...
                            <p style="margin:0 0 16px;">نلاحظ أن الفاتورة التالية قد تجاوزت تاريخ الاستحقاق ولم يتم سدادها بعد:</p>

                            <table role="presentation" width="100%" cellpadding="8" cellspacing="0" style="background-color:#fef2f2; border-radius:6px; margin:0 0 16px;">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bold; color:#dc2626;">{{ $invoice->due_date->format('Y-m-d') }}</td>
                                </tr>
                                <tr>
                            ...
                            <p style="margin:0 0 24px;">نرجو التكرم بسداد المبلغ في أقرب وقت ممكن. لأي استفسار، لا تتردد بالتواصل معنا.</p>
