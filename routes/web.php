...
Route::prefix('admin')->group(function () {
    ...
    // ✅ Login: 5 محاولات فقط/دقيقة لكل IP
...
// ✅ admin = يتحقق أن المستخدم ليس عميلاً
// ============================================================
Route::prefix('admin')->middleware(['auth:sanctum', 'throttle:api', 'admin'])->group(function () {
